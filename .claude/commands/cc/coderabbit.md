...
Review the PR for this branch and read feedback from CodeRabbitAI, then paste one or more CodeRabbit comments.
...
Inform the user:
```
I'll review the CodeRabbit comments with discretion, as CodeRabbit doesn't have access to the entire codebase and may not understand the full context. I'll consider all feedback, including nitpick comments and out of diff feedback.
...
Once you've completed implementing the accepted changes:

1. Commit the changes
2. Update the original PR with the commit
3. Update the original PR with feedback
