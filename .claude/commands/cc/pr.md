...
Ensure that the commit does not include any `.` related files, ie: `.env`, `.mcp.json`, `.claude/**`, etc

Ensure that the commits are free from:
- Hard coded URLs and IP addresses
- Secrets, passphrases and tokens

If hard coded values and or secrets are discovered, **STOP**, report to user
...
Output a final summary report in the format of

```
# PR 312: PROBLEM SOLVED OR FEATURE ADDED

URL: https://github.com/username/project/pull/321
