...
## Acceptance Criteria
- [ ] Session lookup moved before drop_at_and_after for retries
- [ ] Pre-retry session ID stored before dropping
- [ ] Stored session ID used if available
- [ ] Normal follow-ups (non-retry) unchanged
...
## Definition of Done
- [ ] Session lookup reordered
- [ ] Pre-retry session preserved
