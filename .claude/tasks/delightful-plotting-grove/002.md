...
## Acceptance Criteria
- [ ] Test file created at `frontend/src/components/NormalizedConversation/__tests__/UserMessage.test.tsx`
- [ ] All required mocks set up (react-i18next, hooks, contexts)
- [ ] Test: renders injected indicator when metadata.injected is true
- [ ] Test: does not render when metadata is null
- [ ] Test: does not render when metadata is undefined
- [ ] Test: does not render when metadata.injected is false
