...
- [ ] Add useTranslation hook call in component
- [ ] Replace hardcoded "(injected)" with translated text
- [ ] Wrap indicator in Tooltip component with explanatory text
- [ ] Add aria-label attribute for screen readers
- [ ] Add visual styling (border-l-2, pl-2)
- [ ] All unit tests from Task 002 pass
