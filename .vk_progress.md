...
- Manual test: Full end-to-end flow with browser testing

### Remaining Work
1. Frontend checkbox UI in ProjectSettings.tsx
2. i18n translations for all locales
3. E2E browser testing (desktop, tablet, mobile, dark/light mode)
