...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::project::ProjectConfigSuggestion::decl(),
        db::models::project::ProjectConfigField::decl(),
        db::models::project::ConfidenceLevel::decl(),
        ...
        db::models::plan_step::PlanStep::decl(),
        db::models::plan_step::PlanStepStatus::decl(),
        db::models::plan_step::CreatePlanStep::decl(),
        db::models::plan_step::UpdatePlanStep::decl(),
