...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::database_stats::DatabaseStats::decl(),
        ...
        server::routes::database::ArchivedWorkspaceItem::decl(),
        server::routes::database::ArchivedListResponse::decl(),
        server::routes::database::LogSessionItem::decl(),
        server::routes::database::LogListResponse::decl(),
        ...
        db::models::execution_log_event::ExecutionLogEvent::decl(),
        db::models::execution_log_event::CreateExecutionLogEvent::decl(),
        db::models::execution_log_event::ExecutionLogEventType::decl(),
        db::models::execution_log_event::Direction::decl(),
        db::models::execution_log_event::PaginatedExecutionLogEvents::decl(),
        ...
        server::routes::workspaces::files::DirectoryEntry::decl(),
        server::routes::workspaces::files::DirectoryListResponse::decl(),
        server::routes::workspaces::files::FileContentResponse::decl(),
        ...
        services::services::config::FontConfig::decl(),
        ...
        executors::executors::claude_terminal::ClaudeTerminal::decl(),
        executors::executors::claude_terminal::ClaudeTerminalSettingsMergeMode::decl(),
...
fn generate_schemas() -> Result<HashMap<&'static str, String>, serde_json::Error> {
    ...
    let schemas: HashMap<&str, String> = HashMap::from([
        ...
        (
            "claude_terminal",
            generate_json_schema::<executors::executors::claude_terminal::ClaudeTerminal>()?,
        ),
        (
            "gemini",
