...
export const VirtualizedProcessLogs = forwardRef<LogViewerHandle, VirtualizedProcessLogsProps>(
  function VirtualizedProcessLogs(
    { logs, error, searchQuery, matchIndices, currentMatchIndex, blockStartIndices = [], onScrollPositionChange },
    ref
  ) {
