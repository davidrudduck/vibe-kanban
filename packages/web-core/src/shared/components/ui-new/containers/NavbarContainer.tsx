...
export function NavbarContainer({
  ...
  const { workspace: selectedWorkspace, isCreateMode, selectedSession } = useWorkspaceContext();
  ...
  const navbarTitle = isCreateMode
    ...
    : isOnProjectPage
      ? orgName
      : selectedSession?.name ?? selectedWorkspace?.name ?? selectedWorkspace?.branch;
